...
class MobileMain extends Component {
  ...
  componentDidUpdate (prevProps) {
    try {
      ...
      if (
        ...
        if(this.props.currentQuery.from.name === this.props.currentQuery.to.name
          && this.props.currentQuery.from.name === "(Current Location)"){
      ...
      console.log("NAVIGATION ERROR, RELOADING PAGE");
      alert("Seleccione dos puntos distintos.");
      window.location.reload(false);
    }
  }
  ...
  render () {
    ...
    // check same points
    if(this.props.currentQuery.from !== null
      && this.props.currentQuery.to !== null){
        if(this.props.currentQuery.from.name === this.props.currentQuery.to.name
          && this.props.currentQuery.from.name === "(Current Location)"){
            alert("Seleccione dos puntos distintos.");
            window.location.reload(false);
