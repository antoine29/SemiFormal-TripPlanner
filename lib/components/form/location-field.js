  ...
  render () {
    ...
    */
    ...
    const placeholder = currentPosition.fetching === type
      ? 'Obteniendo localizacion... (El GPS debe estar activado)'
      : label || type
